                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <div class="offcanvas-top-area">
                            <div class="create-bg">
                                <a href="{{asset('create')}}" class="offcanvas-create-btn">
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe_5">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-submenu">
                                    <li><a class="dropdown-item" href="{{asset('explore_events')}}">Keşfet</a></li>
                                    <li><a class="dropdown-item" href="{{asset('venue_event_detail_view')}}">Venue Event
                                            Detail
                                            View</a></li>
                                    <li><a class="dropdown-item" href="{{asset('online_event_detail_view')}}">Online
                                            Event
                                            Detail View</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-submenu">
                                    <li><a class="dropdown-item" href="{{asset('faq')}}">SSS</a></li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('sign_up')}}">Kayıt Ol</a>
                            </li>
                            @endguest
                            {{--<li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <li class="dropdown account-dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-account dropdown-menu-end"
                                    ...
                                    <li class="profile-link">
                                        <a href="{{route('my_organisation_dashboard')}}" class="link-item">İşletmem</a>
                                        <a href="{{route('organiser_profile_view')}}" class="link-item">Profilim</a>
                                        <form method="post" action="{{(route('logout'))}}">
                                            @csrf
                                            <button type="submit" href="{{route('logout')}}" class="link-item">Çıkış Yap</button>
                                        </form>
                                    </li>
                                </ul>
                            </li>
