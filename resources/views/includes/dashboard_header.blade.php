<header class="header">
    ...
    <div class="create-bg">
    <a href="/create" class="offcanvas-create-btn">
    ...
    <li class="nav-item">
    <a class="nav-link" href="organiser_profile_view">
    ...
    <h5>John Doe</h5>
    <p><a href="https://www.gambolthemes.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cba1a4a3a5afa4ae8baeb3aaa6bba7aee5a8a4a6">[email&#160;protected]</a></p>
    </div>
    </li>
