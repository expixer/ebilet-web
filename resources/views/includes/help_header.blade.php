<header class="header">
    ...
    <span class="help-center-logo">Help Center</span>
    </a>
    ...
    <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="help_center.html">Home</a>
    </li>
    <li class="nav-item">
    <a class="nav-link" href="help_center_knowledge_base.html">Knowledge Base</a>
    </li>
    </ul>
    </div>
    ...
    <h5>John Doe</h5>
    <p><a href="https://www.gambolthemes.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b6dcd9ded8d2d9d3f6d3ced7dbc6dad398d5d9db">[email&#160;protected]</a></p>
    </div>
    </li>
