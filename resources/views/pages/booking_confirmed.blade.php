...
<!-- Mirrored from www.gambolthemes.net/html-items/barren-html/disable-demo-link/booking_confirmed.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 13:37:41 GMT -->
<head>
    <meta charset="utf-8">
...
{{--                                <li class="breadcrumb-item active" aria-current="page">Rezervasyon Tamamlandı</li>--}}
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="booking-confirmed-content">
                        <div class="main-card">
                            <div class="booking-confirmed-top text-center p_30">
                                ...
                                <h4>Rezervasyon Başarıyla Onaylandı</h4>
                                <p class="ps-lg-4 pe-lg-4">Rezervasyon talebinizin alındığını ve onaylandığını size bildirmekten memnuniyet duyarız.</p>
...
<!-- Mirrored from www.gambolthemes.net/html-items/barren-html/disable-demo-link/booking_confirmed.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 13:37:42 GMT -->
</html>
