...
<!-- Mirrored from www.gambolthemes.net/html-items/barren-html/disable-demo-link/sign_up.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 13:37:28 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="col-lg-10 col-md-10">
                            <div class="app-top-items">
                                ...
                                <div class="app-top-right-link">
                                    Zaten üye misiniz?<a class="sidebar-register-link" href="{{ route('login') }}">Giriş Yap</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-5 col-lg-6 col-md-7">
                            <div class="registration">
                                <form action="{{route('register')}}" method="POST">
                                    @csrf
                                    <h2 class="registration-title">Üye Ol</h2>
                                    <div class="row mt-3">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group mt-4">
                                                <label class="form-label">Adınız*</label>
                                                <input class="form-control h_50" type="text"  placeholder="" name="name" value="{{old('name')}}" >
                                            </div>
                                        </div>
{{--                                        <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group mt-4">
                                                ...
                                                <input class="form-control h_50" name="email" value="{{old('email')}}" type="email" placeholder="" >
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group mt-4">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <button class="main-btn btn-hover w-100 mt-4" type="submit">Kayıt Ol</button>
                                        </div>
                                    </div>
                                </form>
{{--                                <div class="agree-text">
                                    By clicking "Sign up", you agree to Barren <a href="#">Terms & Conditions</a> and
                                ...
                                <div class="new-sign-link">
                                    Zaten Üye Misiniz?<a class="signup-link" href="{{route('sign_in')}}">Giriş Yapın</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="copyright-footer">
                    © 2022, Barren. All rights reserved.
                </div>
            </div>
        </div>
    </div>
