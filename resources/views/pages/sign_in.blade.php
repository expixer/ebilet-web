...
<!-- Mirrored from www.gambolthemes.net/html-items/barren-html/disable-demo-link/sign_in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Dec 2022 13:37:28 GMT -->
<head>
<meta charset="utf-8">
    ...
    <div class="app-form">
        <div class="app-form-sidebar">
            ...
            <div class="sign_sidebar_text">
                <h1>Etkinlik Oluşturmak ve Satın Almanın En Kolay Hali</h1>
            </div>
        </div>
        <div class="app-form-content">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <div class="app-top-items">
                            ...
                            <div class="app-top-right-link">
                                Yeni misiniz?<a class="sidebar-register-link" href="{{asset('sign_up')}}">Kayıt olun.</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6 col-md-7">
                        <div class="registration">
                            <form method="POST" action="{{ route('login') }}">
                                @csrf
                                <h2 class="registration-title">Giriş Yapın</h2>
                                @if ($errors->any())
                                    <div >{{ 'Bir şeyler test gitti.' }}</div>
                                ...
                                <div class="form-group mt-5">
                                    ...
                                    <input id="email" name="email" class="form-control h_50" type="email" placeholder="Email adresinizi giriniz" value="{{old('email')}}" required autofocus>
                                </div>
                                <div class="form-group mt-4">
                                    <div class="field-password">
                                        <label class="form-label">Parola*</label>
                                        <a class="forgot-pass-link" href="{{asset('forgot_password')}}">Parolanızı mı unuttunuz?</a>
                                    </div>
                                    <div class="loc-group position-relative">
                                        <input name="password" id="password" class="form-control h_50" type="password" placeholder="Parolanızı giriniz">
                                        <span class="pass-show-eye"><i class="fas fa-eye-slash"></i></span>
                                    </div>
                                </div>
                                <button class="main-btn btn-hover w-100 mt-4" type="submit" >Giriş yap <i class="fas fa-sign-in-alt ms-2"></i></button>
                            </form>
                            <div class="divider">
                                <span>or</span>
                            </div>
                            ...
                            <div class="new-sign-link">
                                Yeni misiniz?<a class="signup-link" href="{{asset('sign_up')}}">Kayıt Olun</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="copyright-footer">
                © 2022, Barren. Tüm hakları saklıdır.
            </div>
        </div>
    </div>
</div>
